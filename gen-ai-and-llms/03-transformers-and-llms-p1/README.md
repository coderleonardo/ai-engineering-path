...
| Encoder-only (BERT) | — | Covered conceptually only; no dedicated notebook in this course |
...
| Perplexity | Generation | Not directly computed in any project notebook — intrinsic measure, no reference text needed |
...
| Word Error Rate / Token Cost | Generation | Covered conceptually only; no dedicated notebook in this course |
